//
//  XiangCheHeMeiNvViewController.m
//  BaseProject
//
...
#import "iCarousel.h"
@interface XiangCheHeMeiNvViewController ()<iCarouselDelegate, iCarouselDataSource>
@property (nonatomic,strong) iCarousel* ic;
/** 存储图片名称 */
@property (nonatomic,strong) NSArray* imageNames;
@end

@implementation XiangCheHeMeiNvViewController
...
-(NSArray *)imageNames{
    if (!_imageNames) {
        ...
        NSString* path = [[NSBundle mainBundle] pathForResource:@"img" ofType:@"bundle"];
